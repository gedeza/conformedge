      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          ...
          <View>
            ...
            <Text style={s.docNumber}>{props.quotationNumber}</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row", marginBottom: 20, gap: 40 }}>
          <View>
            <Text style={s.infoTitle}>Date Issued</Text>
            <Text style={s.infoText}>{props.issuedDate}</Text>
          </View>
          <View>
            <Text style={s.infoTitle}>Valid Until</Text>
            <Text style={s.infoText}>{props.validUntil}</Text>
          </View>
        </View>
        ...
        <View style={s.totalsSection}>
          <View style={s.totalsRow}>
            <Text style={s.totalsLabel}>Subtotal (excl. VAT)</Text>
        ...
        <View style={s.termsSection}>
          ...
          {props.terms ? (
            <Text style={s.termsText}>{props.terms}</Text>
          ) : (
            <>
              <Text style={s.termsText}>1. This quotation is valid for 30 days from the date of issue.</Text>
              <Text style={s.termsText}>2. Prices are quoted in South African Rand (ZAR) and include VAT at 15%.</Text>
              <Text style={s.termsText}>3. Acceptance of this quotation constitutes agreement to the terms herein.</Text>
              <Text style={s.termsText}>4. Payment terms: as per agreement upon acceptance.</Text>
            </>
          )}
        </View>
