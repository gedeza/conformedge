...
1. [What Is the Partner Program?](#what-is-the-partner-program)
2. [How It Works](#how-it-works)
3. [What Partners Get](#what-partners-get)
4. [Pricing](#pricing)
5. [Why Partner Instead of Direct Subscriptions?](#why-partner-instead-of-direct-subscriptions)
6. [Who Is It For?](#who-is-it-for)
7. [Partner Program vs Partnership Program](#partner-program-vs-partnership-program)
...
The ConformEdge Partner Program lets **consulting firms and compliance professionals** manage multiple client organizations from a single platform. Instead of each client buying their own subscription, you manage everything centrally — one invoice, one dashboard, full visibility.

This is a **structured business platform** where you provide a service to clients through our software. Think of it like a **reseller or managed service model** — you use ConformEdge as the tool to deliver compliance services to your clients at scale.
...
## Why Partner Instead of Direct Subscriptions?

- **Cost savings** — significantly cheaper than individual subscriptions
...
## Partner Program vs Partnership Program

These terms sound similar but mean different things:

### Partner Program (What ConformEdge Offers)
...
- **It's a one-to-many relationship** — one partner, many clients

**Real-world analogy:** An accounting firm using Xero or QuickBooks to manage bookkeeping for 20 clients. The firm is a "partner" of Xero — they use the platform to deliver their service.

### Partnership Program

A **mutual collaboration** between two businesses working together as equals.

- Two companies combine strengths
- Shared goals, shared risk, shared reward
- Co-marketing, co-selling, or co-developing
- **It's a one-to-one relationship** — two partners working together

**Real-world analogy:** Microsoft and Samsung partnering to pre-install Office on Galaxy devices. Both brands benefit equally.
