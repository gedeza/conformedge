...
> **Agreement Date:** [DATE]
> **Agreement Number:** SLA-[CLIENT-CODE]-[YEAR]-[SEQ]
...
<!-- Professional Tier -->
<!-- - Up to 10 users (+R199/user beyond) -->
<!-- - 5 compliance frameworks -->
<!-- - Full safety suite including advanced incident management -->
...
[DELETE UNUSED TIERS AND UNCOMMENT THE APPLICABLE TIER ABOVE]

The full feature set is detailed in the Client Brief.
...
<!-- Essentials Tier: 24h SLA -->
<!-- Professional Tier: 12h SLA -->
<!-- Business Tier: 8h SLA -->
<!-- Enterprise Tier: 4h SLA + dedicated account manager -->
...
- Maximum credit per month: **25% of one month's subscription fee** (R[AMOUNT])
...
All data uploaded to or generated within the ConformEdge platform by [CLIENT COMPANY NAME] remains the **sole property of the Client**. ISU Technologies acts as a data processor, not a data owner.
...
**Designated Client Contact:** [CLIENT CONTACT NAME] ([CLIENT EMAIL] or as advised)
...
- Performance degradation due to excessive usage beyond the [TIER] tier limits
...
This SLA is effective from the platform go-live date and runs concurrent with the [TERM]-month subscription contract.
